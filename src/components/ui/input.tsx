...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "file:text-neutral-950 placeholder:text-neutral-500 selection:bg-neutral-900 selection:text-neutral-50 dark:bg-neutral-700/40 dark:hover:bg-neutral-600/40 border-neutral-200 h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm dark:file:text-neutral-50 dark:placeholder:text-neutral-500 dark:selection:bg-neutral-600/40 dark:selection:text-neutral-900  dark:border-white/40",
