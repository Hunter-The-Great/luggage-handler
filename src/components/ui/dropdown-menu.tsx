...
function DropdownMenuTrigger({
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      className="dark: bg-transparent dark:dark:hover:bg-neutral-700/60 rounded-4xl"
      {...props}
    />
  );
}
